...
Smart Forecast thu thập dữ liệu **chất lượng không khí (Air Quality)** và **thời tiết (Weather)** từ các nguồn mở như **OpenAQ** và **OpenWeatherMap**, sau đó:
...
-   Cho phép **người dân** nhận thông báo, đồng thời **gửi báo cáo sự cố** (ngập lụt, cây đổ, sạt lở...) kèm **vị trí GPS và ảnh** đến trung tâm.
...
| -------------------------- | ------------------------------------------ | ------------------------------------------------------------------------------- |
| **Khải (Mkhai205)**        | PM, Backend, DevOps                        | Lãnh đạo dự án, phát triển backend (Node.js, NGSI-LD), thiết lập Docker & CI/CD |
...
1. **Thu thập dữ liệu (Ingestion Module)**
    ...
    - Lấy dữ liệu từ API OpenAQ và OpenWeatherMap.
...
| **Data Source**      | OpenAQ, OpenWeatherMap         |
...
| `ingestion/`  | Lấy và chuẩn hoá dữ liệu từ OpenAQ, OWM   |
| `airquality/` | Xử lý dữ liệu AQI, tương tác với Orion-LD |
| `weather/`    | Xử lý dữ liệu thời tiết                   |
| `alert/`      | Gửi và quản lý cảnh báo (qua FCM)         |
| `incident/`   | Báo cáo sự cố từ người dân                |
| `analysis/`   | Thống kê, biểu đồ, AI nhẹ                 |
| `file/`       | Upload ảnh sự cố (MinIO)                  |
