...
import { Bell, Check, Trash2, Settings as SettingsIcon, AlertTriangle, FileText, Cloud, Key, Database, Zap } from 'lucide-react';
                        ...
                        <div className="divide-y divide-slate-100">
                            {displayedNotifications.map((notification) => {
                                ...
                                return (
                                    <div
                                        key={notification.id}
                                        className={`px-4 py-2.5 hover:bg-slate-50 transition-colors ${!notification.read ? 'bg-blue-50/50' : ''
                                            }`}
                                    >
